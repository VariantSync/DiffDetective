...
public class AddIfdefMultipleRegexPattern extends EditPattern {
    public static final String PATTERN_NAME = "AddIfDefMultipleRegex";

    public AddIfdefMultipleRegexPattern() {
