...
public class PatchScenario<L extends Label> {
	...
	public PatchScenario(VariationDiff<L> sourcePatch,
		...
		this.unchangedAfter = new Unchanged((VariationDiff<DiffLinesLabel>) sourcePatch, Time.AFTER);
		Unchanged unchangedBefore = new Unchanged((VariationDiff<DiffLinesLabel>) sourcePatch, Time.BEFORE);
