...
public class CExpressionParser extends Parser {
	...
	public static final int
		...
		DigitSequence=55, StringLiteral=56, PathLiteral=57, NumberSign=58, AsmBlock=59, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PathLiteral", "NumberSign", "AsmBlock", "Whitespace", "Newline", "BlockComment", 
			"LineComment"
		};
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(CExpressionParser.EOF, 0); }
