...
public interface DiffTreeLabelFormat {
	 ...
	 */
	DiffTreeSource readTreeHeaderFromLineGraph(final String lineGraphNodeLine);
	 ...
	 */
	String writeTreeHeaderToLineGraph(final DiffTreeSource diffTreeSource);
	 ...
	 */
	static String extractRawTreeLabel(String lineGraphNodeLine) {
	 ...
	 */
	static String setRawTreeLabel(String lineGraphNodeLine) {
